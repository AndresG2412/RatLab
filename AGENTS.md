- Unity 6000.6.2f1, proyecto 2D (URP), C#.
- UI con uGUI (Canvas) + TextMeshPro.
- Scripts en Assets/Scripts/ con subcarpetas Core, UI y Data.
- La lógica del juego va en clases C# puras (sin MonoBehaviour), separada de las vistas.
